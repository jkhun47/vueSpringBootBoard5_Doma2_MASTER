    ...
    <div class="board-list">
        ...
        <div>
            ...
            <form class="w3-container">
                <input class="w3-input" type="text" v-model="search_value" @keyup.enter="fnPage()">
            </form>
            &nbsp;
            <button class="w3-button w3-round w3-pale-green  w3-hover-green" @click="fnPage()">검색</button>
        </div>
    </div>
</template>
